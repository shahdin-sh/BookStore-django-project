...
urlpatterns = [
    ...
    path('<int:pk>/update/comment', login_required(CommentUpdateView.as_view()), name='update_comments'),
    path('<int:pk>/delete/comment', login_required(CommentDeleteView.as_view()), name='delete_comments'),
